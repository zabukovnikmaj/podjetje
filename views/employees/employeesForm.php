...
<form action="" method="POST">
    ...
    <input type="text" name="branchOffice" value="<?php echo $formData['branchOffice'] ?? ''; ?>"> <br> <br>

    <label for="name">Employee name</label><br>
    <input type="text" name="name" value="<?php echo $formData['name'] ?? ''; ?>"> <br> <br>

    <label for="position">Employee position</label><br>
    <input type="text" name="position" value="<?php echo $formData['position'] ?? ''; ?>"> <br> <br>

    <label for="age">Employee age<label><br>
    <input type="number" name="age" step="1" min="15" max="100" value="<?php echo $formData['age'] ?? ''; ?>"><br><br>

    <label for="sex">Employee sex</label><br>
    <input type="text" name="sex" value="<?php echo $formData['sex'] ?? ''; ?>"> <br> <br>

    <label for="email">Employee email</label><br>
    <input type="email" name="email" value="<?php echo $formData['email'] ?? ''; ?>"> <br> <br>
